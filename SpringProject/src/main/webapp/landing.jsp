...
<body>
			...
			<ul class="navbar-nav">
				...
				<li class="dropdown"><a class="dropdown-toggle" href="#"
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="generic.html">Generic</a> <a
	...
	<div class="container">
		<div
			...
			<div class="banner-content col-lg-6 col-md-12">
				<h1>
					We Provide <br> <span>Solutions</span> that <br> Brings <span>Joy</span>
				</h1>
				<a href="#" class="primary-btn2 header-btn text-uppercase">Hire
					Us Now!</a>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="sigle-service col-lg-3 col-md-6">
				...
				<p>inappropriate behavior is often laughed off as “boys will be
					boys,” women face higher conduct.</p>
				<a href="#"
					class="text-uppercase primary-btn2 primary-border circle">View
					Details</a>
			</div>
			<div class="sigle-service col-lg-3 col-md-6">
	...
	<div class="container-fluid">
		<div
			class="row justify-content-end align-items-center d-flex no-padding">
			<div class="col-lg-6 about-left mt-70">
				<h1>
					We can be your digital <br> Problems Solution Partner
				</h1>
				<p>
					inappropriate behavior is often laughed off as “boys will be <br>
					boys,” women face higher conduct standards especially <br> in
					the workplace. That’s why it’s crucial that, as women, our <br>
					behavior on the job is beyond reproach.
				</p>
				<div class="buttons">
					<a href="#" class="about-btn text-uppercase primary-border circle">What
						we offer</a> <a href="#"
						class="about-btn text-uppercase  primary-border circle">Get a
						free quote</a>
				</div>
			</div>
				...
				<div class="item">
					...
					<div class="caption text-center mt-20">
						...
						<p>
							...
							that make them work have <br> allowed humanity to create
							slimmer, more portable technology.
						</p>
					</div>
				</div>
				<div class="item">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 skill-left">
				...
				<p>
					inappropriate behavior is often laughed off as “boys will be <br>
					boys,” women face higher conduct standards especially in <br>
					the workplace. That’s why it’s crucial that.
				</p>
			</div>
